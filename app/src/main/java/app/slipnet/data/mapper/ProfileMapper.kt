...
class ProfileMapper @Inject constructor(
    ...
    fun toDomain(entity: ProfileEntity): ServerProfile {
        ...
        return ServerProfile(
            ...
            vlessFailureProviderId = entity.vlessFailureProviderId,
            vlessFailureAccountId = entity.vlessFailureAccountId,
            vlessFailureHostname = entity.vlessFailureHostname,
            vlessEchConfigSeed = entity.vlessEchConfigSeed,
            vlessEchConfigUpdatedAt = entity.vlessEchConfigUpdatedAt,
            cdnIp = entity.cdnIp,
